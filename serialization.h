...
namespace serialization {
	...
	public:
		...
		void CatalogueSerialize(const TransportCatalogue::TransportCatalogue& catalog, TransportCatalogue::BusTimesSettings time_settings, RenderSettings settings) const;
